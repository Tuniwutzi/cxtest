...
// Compiletime only
consteval void test_meta_name_of(cxt::CTContext& ctx)
{
...
// Compile- and Runtime
constexpr void test_templated_name_of(cxt::Context& ctx)
{
    ctx.check(string_utils::name_of<int>() == "int");
...
// Runtime only
void test_rtti_name_of(cxt::RTContext& ctx)
{
...
auto _ = cxt::register_tests<^^name_of>("name_of");
